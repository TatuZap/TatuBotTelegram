...
install:
	...
	python$(PYTHON_VERSION) -m pip install pymongo
	python$(PYTHON_VERSION) -m pip install lxml
	python$(PYTHON_VERSION) -m pip install openpyxl
	python$(PYTHON_VERSION) -m pip install pyTelegramBotAPI
	python$(PYTHON_VERSION) -m pip install python-dotenv
	python$(PYTHON_VERSION) -m pip install tabula-py
